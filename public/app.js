...
// Relative path: works locally (server serves this file + /api on the same
// port) and once deployed live (same origin, whatever domain that ends up
// being) — no hardcoded host needed.
const API_BASE = '/api';
